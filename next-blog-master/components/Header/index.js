...
const routes = [
  ...
  {
    href: ROUTER.BOSS_STRIKE,
    txt: ROUTER.BOSS_STRIKE_TXT,
    isSuperAdmin: false,
    isArticleList: false
  },
  {
...
class TopNav extends Component {
  ...
  componentDidMount() {
    ...
    postAdminPassword(dispatch, postAdminPasswordUrl(), { password: password })
      .then(res => {
        ...
        <Layout>
          ...
          <Row>
            <Col sm={{ span: 24, offset: 0 }}
              ...
              <Content style={{ marginTop: userAgent === 'pc' ? 64 : 0 }}>
                <DynasicTopTipsNoSsr />
              </Content>
            </Col>
          </Row>
